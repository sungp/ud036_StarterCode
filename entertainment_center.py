...
blade_runner_2049 = media.Movie("Blade Runner 2049",
                                ("LAPD officer investigates a dark secret that"
                                 " would bring an end to humanity"),
                                ("https://upload.wikimedia.org/wikipedia/en/2/"
                                 "27/Blade_Runner_2049_logo.png"),
                                "https://youtu.be/2Wroofd1bB0")

# instantiate Star Wars Episode VIII
star_wars_8 = media.Movie("Star Wars VIII: The Last Jedi",
                          ("A fate of the galaxy hinges on a young woman who "
                           "possesses the power to wield the force"),
...
ready_player_one = media.Movie("Ready Player One",
                               ("A young man takes the search of life time in "
                                "VR world"),
                               ("https://upload.wikimedia.org/wikipedia/en/7/"
                                "74/Ready_Player_One_%28film%29.png"),
